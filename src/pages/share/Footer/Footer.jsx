  ...
  return (
    <div className="mt-20 bg-[#F4D2B6]">
      <div className="pt-12 md:flex justify-center items-center  gap-10 text-center">
        ...
        <div>
          <input
            className="h-14 p-4 rounded-s-md my-3"
            type="email"
            name=""
            id=""
          ...
          />
          <input
            className="h-14 w-28 p-4 bg-black text-white rounded-md"
            type=" submit"
            name=""
            value="Subscribe"
          />
            ...
            <footer className="footer p-10 bg-[#F4D2B6] text-base-content">
              <div className="text-black">
                ...
                >
                  <Link
                    to=""
                    className="no-underline  link  hover:text-orange-400"
                  >
                    My Account
                  </Link>
                  <Link
                    to=""
                    className="link no-underline hover:text-orange-400  mt-3 md:mt-6"
                  >
                    Order History
                  </Link>
                  <Link
                    to=""
                    className="link   mt-3 no-underline hover:text-orange-400"
                  >
                    Wish List
                  </Link>
                  <Link
              ...
              <div className="text-black  md:ml-16">
                ...
                <div
                  ...
                  style={{ fontSize: "16px" }}
                >
                  <Link className="link hover:text-orange-400 no-underline">
                    Brands
                  </Link>
                  <Link
                    to=""
                    className="link mt-3 md:mt-6 hover:text-orange-400 no-underline"
                  >
                    Gift Certificates
                  </Link>
                  <Link
                  ...
                  <div className="mt-2">
                    <div className="mt-2">
                      <div className="flex gap-2">
                        ...
                        />
                        <p>
                          A20 Green Hill Road, <br /> Fayetteville, California.
                        </p>
                      </div>
                      <div className="flex gap-2 items-center">
                      <FontAwesomeIcon className="mt-2" icon={faPhone} />  
                      <p className="font-bold text-xl mt-2">
                          +1 209-223-2635
                        </p>
                      </div>
                      <div className="flex items-center gap-2 ">
                      <FontAwesomeIcon className="mt-2" icon={faEnvelope} />
        ...
        <div className="text-center md:flex justify-between mt-4">
          ...
          <div className="text-white mt-4 md:mt-0 ">
            <div className="flex gap-4 justify-center">
              ...
              <a className="hover:bg-orange-400"></a>
            </div>
          </div>
        </div>
      </footer>
